...
-- Edit the Vim files
map('n', '<leader>vim', ':lua require("plug-config.telescope").search_vimfiles()<cr>', opts)
map('n', '<leader>dot', ':lua require("plug-config.telescope").search_dotfiles()<cr>', opts)

-- Todos
map('n', '<leader>to', ':lua require("plug-config.telescope").search_todo()<cr>', opts)
